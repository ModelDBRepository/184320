'''
Current clamp demo using Allen Brain's model 473834758.
...
from neuron473834758 import Neuron473834758
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473834758(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473834758; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-96.3921763102)
        h.fcurrent()
